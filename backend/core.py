    ...
    def get_chatbot(self, query: str) -> dict:
        ...
        try:
            ...
            if not self.index_exists():
                raise RuntimeError(f"Index '{self._index_name}' does not exist. Please ingest documents first.")
            ...
            qa = create_retrieval_chain(retriever=doc_search, combine_docs_chain=stuff_docs_chain)
